...
<div class="row">
	<div class="col-sm-6">
		<div class="form-group">
             ...
             {!! Form::select ('id_Escuela',$escuela->pluck('nombre_escuela','id')->all(),$aspirantes->id_Escuela,['placeholder'=>'--Seleccionar--','class'=>'form-control']) !!}
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			{{ Form::select('niv_educativo',$nivel->pluck('nombreNivel','id')->all(), $aspirantes->niv_educativo, ['class' => 'form-control','placeholder'=>'--Seleccionar--']) }}
