...
{!! Form::open(['url'=>'/becas', 'method'=>'POST']) !!}
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
            ...
            {!! Form::text ('est_paterno',null,['placeholder'=>'Ingrese apellido paterno','class'=>'form-control','required','pattern'=>'[A-Za-z] {1-50}']) !!}
		</div>
	</div>
	...
	<div class="col-sm-4">
		...
		<div class="form-group">
            ...
            {!! Form::text ('est_materno',null,['placeholder'=>'Ingrese apellido paterno','class'=>'form-control','required']) !!}
		</div>
	...
	<div class="col-sm-4">
		<div class="form-group">
            ...
            {!! Form::text ('est_nombre',null,['placeholder'=>'Ingrese nombre(s)','class'=>'form-control','required']) !!}
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
            ...
            {!! Form::text ('est_calle',null,['placeholder'=>'Ingrese calle','class'=>'form-control','required']) !!}
		</div>
	</div>
	...
	<div class="col-sm-4">
		<div class="form-group">
            ...
            {!! Form::text ('est_numero',null,['placeholder'=>'Ingrese numero','class'=>'form-control','required']) !!}
		</div>
	</div>
	...
	<div class="col-sm-4">
		<div class="form-group">
            ...
            {!! Form::text ('est_barrio',null,['placeholder'=>'Ingrese barrio o colonia','class'=>'form-control','required']) !!}
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-4">
		...
		<div class="form-group">
			...
			{{ Form::select('niv_educativo',['Primaria' => 'Primaria', 'Secundaria' => 'Secundaria', 'Medio Superior' => 'Medio Superior'], null, ['class' => 'form-control','required','placeholder'=>'--Seleccionar--']) }}
		</div>
		<br>
	...
	<div class="col-sm-4">
		...
		<div class="form-group">
			    ...
			    {{ Form::select('est_grado',['Primero' => 'Primero', 'Segundo' => 'Segundo', 'Tercero' => 'Tercero','Cuarto' => 'Cuarto','Quinto' => 'Quinto', 'Sexto' => 'Sexto'], null, ['class' => 'form-control','required','placeholder'=>'--Seleccionar--']) }}
...
<div class="form-group">
          ...
          {!! Form::text ('nom_escuela',null,['placeholder'=>'Ingrese nombre de la escuela','class'=>'form-control','required']) !!}
</div>
<br>
...
<div class="form-group">
          ...
          {!! Form::text ('n_padre',null,['placeholder'=>'Ingrese nombre completo del padre (Apellido Paterno, Apellido Materno, Nombre(s))','class'=>'form-control','required']) !!} 
...
<div class="form-group">
          ...
          {!! Form::text ('n_madre',null,['placeholder'=>'Ingrese nombre completo de la madre (Apellido Paterno, Apellido Materno, Nombre(s))','class'=>'form-control','required']) !!}
